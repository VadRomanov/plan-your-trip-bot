...
public class SummaryServiceImpl implements SummaryService {
    ...
    public ResponseFileDto getTripSummaryPdf(long id) {
        ...
        var response = retryTemplate.execute(retryCallback -> tripCoreClient.getTripSummaryPdf(id));
    ...
    public String getTripSummaryText(long id) {
        log.debug("Get trip summary plain text by {}", id);
        var response = retryTemplate.execute(retryCallback -> tripCoreClient.getTripSummaryPlainText(id));
        log.debug("Get trip summary plain text by {}", id);
        return response;
    }
}
